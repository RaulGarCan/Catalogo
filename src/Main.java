...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Autor pedroAlmodovar = new Autor("Pedro Almodóvar", null);
        ...
        Autor georgeTMiller = new Autor("George T. Miller", null);
        ...
        Autor pabloRuizPicasso = new Autor("Pablo Ruíz Picasso",null);
